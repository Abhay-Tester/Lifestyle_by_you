...
// Always default to configured firestoreDatabaseId in firebase-applet-config.json ("aistudio-dev")
export const dbId = envDbId || (firebaseConfig.firestoreDatabaseId && firebaseConfig.firestoreDatabaseId !== '(default)' ? firebaseConfig.firestoreDatabaseId : 'aistudio-dev');
